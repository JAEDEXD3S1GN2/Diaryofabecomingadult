  ...
  return (
    ...
    >
     ...
     <div className=' relative z-10 rounded-[10px] bg-cream/70 w-[90%] sm:w-max px-3 py-5'>
      ...
      <p className='text-black font-bold text-xl font-Merriwether mb-8.75'>Growing up isn't a destination - it's a story still being written..</p>
      <Link className='text-black font-bold text-xl font-Merriwether bg-orangeBrand w-max rounded-md px-3 py-3 hover:bg-green-400 hover:text-white'>Explore Thoughts</Link>
     </div>
    </div>
  )
}
